    ...
    <div className="news-list-container">
      <div>
        <div className="news-filter bgColor">
          ...
          <div
            className={type == 'positive' ? 'active' : ''}
            onClick={() => filter('positive')}
          >
            긍정
          </div>
          <div
            className={type == 'neutral' ? 'active' : ''}
            onClick={() => filter('neutral')}
          >
            중립
          </div>
          <div
            className={type == 'negative' ? 'active' : ''}
