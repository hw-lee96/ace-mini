...
async def get_most_liked_news():
    cursor = news_data.find({}, {"title": 1, "summary": 1, "date": 1, "img": 1, "views": 1, "like": 1}).sort("like", DESCENDING).limit(5)
...
async def get_most_viewed_news():
    cursor = news_data.find({}, {"title": 1, "summary": 1, "date": 1, "img": 1, "views": 1, "like": 1}).sort("views", DESCENDING).limit(5)
